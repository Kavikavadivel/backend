...
const db = mysql.createConnection({
  ...
  user: 'sql12792672',  // Replace with your MySQL username
  password: 'JuPTTrLT8B',  // Replace with your MySQL password
  database: 'sql12792672',
  port:'3306'
});
...
app.post('/recipes', (req, res) => {
  ...
  db.query('INSERT INTO recipe (title, ingredients, instructions) VALUES (?, ?, ?)', [title, ingredients, instructions], (err) => {
    if (err) throw err;
